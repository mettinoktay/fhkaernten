...
\begin{figure}[H]
    ...
    \begin{minipage}{0.4\textwidth}
        ...
        \caption{\small A close up of an FDM 3D Printer \cite{3dprinting}}
    \end{minipage}
    \begin{minipage}{0.4\textwidth}
        \centering
        \fbox{\includegraphics[scale=0.3]{../pics/FDM}}
        \caption{\small Overview of FDM technique \cite{fdm}}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.4\textwidth}
        ...
        \caption{\small A stainless steel nozzle \cite{nozzle}}
    \end{minipage}
    \begin{minipage}{0.4\textwidth}
        \centering
        \fbox{\includegraphics[scale=0.3]{../pics/hotend}}
        \caption{\small A hotend \cite{hotend}}
    \end{minipage}
\end{figure}
